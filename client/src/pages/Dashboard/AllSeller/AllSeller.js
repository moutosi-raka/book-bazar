...
const AllSeller = () => {
    ...
    const handleVerify = id =>{
        fetch(`https://book-bazar-server-moutosi-raka.vercel.app/api/user/seller/verify/${id}`,{
            method: 'PUT',
            headers: {
    ...
    const handleDeleteSeller =(seller) =>{
        fetch(`https://book-bazar-server-moutosi-raka.vercel.app/api/user/delete/${seller._id}`,
        {
            method: 'DELETE',
            headers: {
                authorization: `bearer ${localStorage.getItem('accessToken')}`
