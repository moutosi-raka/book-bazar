...
const MyOrder = () => {
    ...
    const url = `https://book-bazar-server-moutosi-raka.vercel.app/api/booking/list?email=${user?.email}`;
    ...
    return (
        <div>
            <h1 className='text-xl md:text-3xl  f-family-abril fw  my-8 text-linear'>My Orders</h1>
