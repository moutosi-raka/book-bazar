...
const MyProduct = () => {
    ...
    return (
        <div>
            ...
            <h1 className='text-xl md:text-3xl  f-family-abril fw  my-8 text-linear'>My Product</h1>
            <h1 className='text-xl hidden md:block md:text-3xl f-family-abril fw  my-8 text-linear'>Total Product {myProducts.length}</h1>
